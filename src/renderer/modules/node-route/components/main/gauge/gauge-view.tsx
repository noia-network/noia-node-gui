...
import "./gauge-view.scss";

interface Props {
    degree: number;
}

export class GaugeView extends React.Component<Props> {
    public render(): JSX.Element {
        let degree: number;
        if (this.props.degree >= 240) {
            degree = 240;
        } else if (this.props.degree <= 0) {
            degree = 0;
        } else {
        ...
        return (
            <svg width="149.884" height="114.339" className="gauge-view">
                <defs>
                    <linearGradient x1=".874" y1=".449" x2="-.031" y2=".833" id="a">
                        <stop stopColor="#A0F1B3" offset="0%" />
                        <stop stopColor="#232AA2" offset="100%" />
                    </linearGradient>
                    <linearGradient
                        x1="120.73"
                        y1="29.774"
                        ...
                        y2="68.28"
                        id="e"
                        gradientTransform="scale(.93044 1.07476)"
                        gradientUnits="userSpaceOnUse"
                    >
                        <stop stopColor="#D3D5F5" offset="0%" />
                        <stop stopColor="#3036A8" offset="100%" />
                    </linearGradient>
                    <linearGradient
                        xlinkHref="#a"
                        id="d"
                        ...
                        x2="-4.063"
                        y2="109.014"
                        gradientTransform="scale(1.14493 .87341)"
                        gradientUnits="userSpaceOnUse"
                    />
                    <linearGradient
                        xlinkHref="#a"
